...
| [AppSync](docs/services/appsync.md) | ✅ Core | `/v1/apis` path prefix | GraphQL API (CRUD), schema upload, Lambda data sources, resolvers, API keys, tags — all state in memory; no query execution |
