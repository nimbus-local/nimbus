...
| [EC2 (VPC)](docs/services/ec2.md) | ✅ Core | `POST /` form-encoded body | VPC, Subnet, Internet Gateway, Security Group (default), Route Table, Route, RouteTableAssociation, Tags, DescribeAvailabilityZones — full lifecycle for Pulumi `NewVpc` construct |
